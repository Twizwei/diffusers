...
# OUTPUT_DIR="/vulcanscratch/yiranx/sc4d/flux_ckpts/garden_16_sdxl_t2i_adapter_raymap_lr"
# python examples/t2i_adapter/train_t2i_adapter_sdxl_custom.py --pretrained_model_name_or_path=$MODEL_DIR \
#     --output_dir=$OUTPUT_DIR  --train_data_dir=/vulcanscratch/yiranx/sc4d/datasets/garden_16 \
#     --mixed_precision="fp16"  --resolution=1024  --learning_rate=1e-5 --lr_scheduler "cosine_with_restarts"  --max_train_steps=15000 \
#     --validation_image "/vulcanscratch/yiranx/sc4d/datasets/garden_16/conditioning_images/000.png" \
#     --validation_prompt "A garden view. A table is in the middle. There is a vase on the table." \
#     --validation_steps=100  --train_batch_size=1  --gradient_accumulation_steps=4  --report_to="wandb" \
#     --seed=42  --push_to_hub  --pretrained_vae_model_name_or_path madebyollin/sdxl-vae-fp16-fix \
#     --adapter_in_channels 15  --validation_raymap_target /vulcanscratch/yiranx/sc4d/datasets/garden_16/raymaps/012.npy

OUTPUT_DIR="/vulcanscratch/yiranx/sc4d/flux_ckpts/garden_16_sdxl_dreambooth_lora_t2i_adapter_raymap"
accelerate launch examples/t2i_adapter/train_t2i_adapter_sdxl_custom.py --pretrained_model_name_or_path=$MODEL_DIR \
     --output_dir=$OUTPUT_DIR  --train_data_dir=/vulcanscratch/yiranx/sc4d/datasets/garden_16 \
     --mixed_precision="fp16"  --resolution=1024  --learning_rate=1e-5 --max_train_steps=15000 \
     --validation_image "/vulcanscratch/yiranx/sc4d/datasets/garden_16/conditioning_images/000.png" \
     --validation_prompt "A sks garden view. A table is in the middle. There is a vase on the table." \
     --validation_steps=100  --train_batch_size=1  --gradient_accumulation_steps=4  --report_to="wandb" \
     --seed=42  --push_to_hub  --pretrained_vae_model_name_or_path madebyollin/sdxl-vae-fp16-fix \
     --adapter_in_channels 15  --validation_raymap_target /vulcanscratch/yiranx/sc4d/datasets/garden_16/raymaps/012.npy \
     --pretrained_lora_name_or_path "/vulcanscratch/yiranx/sc4d/flux_ckpts/garden_16_sdxl_dreambooth_lora"